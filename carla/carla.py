...
def main(i):
    ...
    ga_search = GeneticMultiProcessSearchAlgorithm(processes=20, config=ga_config)
    ...
    with open(f"./outputs/{i}.txt", "w") as out:
        out.write(str(res) + "\n" + str(iter))
    df.to_csv(f"./outputs/{i}_full.csv")
...
if __name__ == "__main__":
    ...
    all_finished = os.listdir("./outputs")
